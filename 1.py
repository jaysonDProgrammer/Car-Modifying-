...
#OBstacle....this code are the list of cars and it will randomly choose which one will appear. 
...
#Displaying the score at the background. Basically just passing the score and passed 
...
def game_loop():
    ...
    while not bumped:
        ...
        #it will work when i just put one image  but not  animated
