...
def instruction():
    ...
    while instruction:
        ...
        obtextSurf,obtextRect=text_objects("Collect coins for points, heart for extra life and missile for bullets", smalltext)
...
def countdown_background():
    ...
    carshoot=font.render("CAR SHOOT: 0",True, red)
